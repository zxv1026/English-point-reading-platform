...
import { contentFindList } from "../../../redux/content_redux";
...
class Condition extends Component{
    ...
    handleSubmit(){
        this.props.form.validateFields((err, values) => {
            if (!err) {
                console.log(values);
                this.props.contentFindList(values);
                // this.props.hide()
            }
        })
    }
                ...
                <Form {...formItemLayout} className="login-form">
                    ...
                    >
                        {getFieldDecorator('chinese',{
                            ...
                            <Input placeholder='请输入想要查找的中文语句' allowClear/>
                        )}
                    </FormItem>
                    <FormItem
                        label="英文语句"
                    >
                        {
                            ...
                            <Input placeholder='请输入想要查找的英文语句' allowClear/>
                        )}
                    </FormItem>
